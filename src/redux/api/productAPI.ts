...
import {
    AllProductsResponse, CategoriesResponse, DeleteProductRequest, MessageResponse,
    NewProductRequest, SearchProductsRequest, SearchProductsResponse,
...
export const productAPI = createApi({
    ...
    endpoints: (builder) => ({
        ...
        changeRating : builder.mutation<MessageResponse, UpdateProductRatingRequest>({query:({avgRate,id})=>({
            url: `/change/${id}`,
            method: "PUT",
            body: avgRate,
        }),
